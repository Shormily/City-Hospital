...
const Contact = () => {
    return (
        <>
            <div className="contact-img text-center"><h1 className='pragraph-weight text-light
             mt-5'>Contact US / Home</h1></div>
      <div className="container">
        <div className="row">
          <div className="col-lg-4 col-md-4 col-sm-12 " >
            <i class="fa-solid fa-phone fa-3x mt-5 mb-4 font-icn"></i>
          ...
          <div className="col-lg-4 col-md-4 col-sm-12" >
            <i class="fa-solid fa-envelope fa-3x mt-5 mb-4 font-icn"></i>
          ...
          <div className="col-lg-4 col-md-4 col-sm-12">
            <i class="fa-solid fa-location-arrow fa-3x mt-5 mb-4 font-icn"></i>
